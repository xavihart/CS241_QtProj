...
public:
    ...
    void setupUi(QMainWindow *plotdata)
    {
        ...
        label_min->setGeometry(QRect(360, 100, 71, 17));
        ...
        label_sec->setGeometry(QRect(360, 130, 67, 17));
        ...
        label_4->setGeometry(QRect(20, 130, 151, 21));
