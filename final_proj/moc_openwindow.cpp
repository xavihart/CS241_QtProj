...
QT_MOC_LITERAL(1, 11, 25), // "data_loading_thread_begin"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 14) // "change_progbar"

    },
    "openwindow\0data_loading_thread_begin\0"
    "\0change_progbar"
};
#undef QT_MOC_LITERAL
...
void openwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->data_loading_thread_begin(); break;
        case 1: _t->change_progbar((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
